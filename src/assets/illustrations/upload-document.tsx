  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="none"
      />
      <path d="M65 15L85 33" stroke="currentColor" strokeWidth="2" opacity="0.2" fill="none" />
      ...
      {/* Upload arrow circle */}
      <circle cx="75" cy="80" r="25" fill="#0F0F10" stroke="#19abb5" strokeWidth="2" />

      {/* Upload arrow */}
      <path d="M75 68V92" stroke="#19abb5" strokeWidth="2.5" strokeLinecap="round" />
      <path
