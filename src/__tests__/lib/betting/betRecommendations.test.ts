...
function createClassifiedHorse(overrides: Partial<ClassifiedHorse> = {}): ClassifiedHorse {
...
function createTierGroup(tier: 'tier1' | 'tier2' | 'tier3', horses: ClassifiedHorse[]): TierGroup {
  const tierNames = {
    tier1: 'Cover Chalk',
