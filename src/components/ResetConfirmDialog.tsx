          ...
          {totalChanges > 0 && (
            <div className="reset-changes-list">
              <p className="changes-summary">
                <span className="changes-count">{totalChanges}</span> change{totalChanges !== 1 ? 's' : ''} will be reverted:
              </p>
              <ul className="changes-items">
                ...
                {changesCount.scratches > 0 && (
                  <li className="change-item">
                    ...
                    <span>{changesCount.scratches} horse{changesCount.scratches !== 1 ? 's' : ''} unscratched</span>
                  </li>
                )}
                {changesCount.oddsChanges > 0 && (
                  <li className="change-item">
                    <Icon name="attach_money" className="change-icon" />
                    <span>{changesCount.oddsChanges} odds change{changesCount.oddsChanges !== 1 ? 's' : ''} reverted</span>
                  </li>
                )}
              </ul>
            </div>
