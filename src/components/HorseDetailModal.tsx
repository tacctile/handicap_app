    ...
    <div className={`category-card ${isExpanded ? 'expanded' : ''}`}>
      ...
      {isExpanded && (
        <div className="category-card-content">
          ...
          <div className="category-details">{details}</div>
        </div>
      )}
    </div>
  );
  ...
  const keyFactors = useMemo(() => {
    ...
    if (b.postPosition.trackBiasApplied) {
      if (b.postPosition.total >= SCORE_LIMITS.postPosition * 0.7) {
        factors.push({
          icon: 'trending_up',
          text: 'Favorable post with track bias',
          type: 'strength',
        });
      } else if (b.postPosition.total < SCORE_LIMITS.postPosition * 0.3) {
        factors.push({
          icon: 'trending_down',
          text: 'Disadvantaged post position',
          type: 'weakness',
        });
      }
    }
    ...
    if (b.speedClass.total >= SCORE_LIMITS.speedClass * 0.8) {
      factors.push({
        icon: 'bolt',
        text: 'Strong speed figures and proven at class',
        type: 'strength',
      });
    } else if (b.speedClass.total < SCORE_LIMITS.speedClass * 0.3) {
      factors.push({
        icon: 'trending_flat',
        text: 'Below par speed figures or class rise',
        type: 'weakness',
      });
    }
    ...
    if (paceAnalysis.tactical.level === 'excellent') {
      factors.push({
        icon: 'speed',
        text: `Excellent pace fit: ${paceAnalysis.tactical.fit}`,
        type: 'strength',
      });
    } else if (paceAnalysis.tactical.level === 'good') {
      factors.push({ icon: 'speed', text: 'Good pace scenario fit', type: 'strength' });
    } else if (
      paceAnalysis.tactical.level === 'poor' ||
      paceAnalysis.tactical.level === 'terrible'
    ) {
      factors.push({
        icon: 'warning',
        text: `Poor pace fit: ${paceAnalysis.tactical.fit}`,
        type: 'weakness',
      });
    }
    ...
    if (overlay.overlayPercent >= 100) {
      factors.push({
        icon: 'rocket_launch',
        text: `Massive ${formatOverlayPercent(overlay.overlayPercent)} overlay - exceptional value!`,
        type: 'strength',
      });
    } else if (overlay.overlayPercent >= 50) {
      factors.push({
        icon: 'trending_up',
        text: `Strong ${formatOverlayPercent(overlay.overlayPercent)} overlay - excellent value`,
        type: 'strength',
      });
    } else if (overlay.overlayPercent >= 25) {
      factors.push({
        icon: 'thumb_up',
        text: `Good ${formatOverlayPercent(overlay.overlayPercent)} overlay`,
        type: 'strength',
      });
    } else if (overlay.overlayPercent <= -20) {
      factors.push({
        icon: 'do_not_disturb',
        text: `${formatOverlayPercent(overlay.overlayPercent)} underlay - avoid`,
        type: 'weakness',
      });
    }
  ...
  return (
    ...
    >
      <div className="horse-modal horse-modal-responsive">
        ...
        <ErrorBoundary
          componentName="HorseDetailModal"
          fallback={
          ...
          <header className="modal-header modal-header-responsive">
            <div className="modal-header-top modal-header-top-responsive">
              <div className="horse-identity horse-identity-responsive">
                ...
                <h2 id="horse-modal-title" className="horse-name-large">
                  {horse.horseName}
                </h2>
              </div>
          ...
          <div className="modal-content modal-content-responsive">
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        style={{ color: getDiamondColor(), fontWeight: 700, fontSize: '1.1rem' }}
                      >
                        {diamondAnalysis.factorCount}
                      </div>
                    </div>
                    <div
                      style={{
                        ...
                        >
                          ...
                          >
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                              <Icon name={FACTOR_ICONS[factor.type]} className="text-base" />
                              <span
                                style={{
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {diamondAnalysis.roiPotential > 0 ? '+' : ''}
                        {(diamondAnalysis.roiPotential * 100).toFixed(0)}%
                      </span>
                    </div>
                  </div>
                  ...
                  details={
                    <div className="breakdown-details">
                      ...
                      {dynamicConnections?.trainerPattern?.relevantPattern && (
                        ...
                        >
                          {dynamicConnections.trainerPattern.relevantPattern.winRate.toFixed(0)}%
                          win ({dynamicConnections.trainerPattern.relevantPattern.starts} starts){' '}
                      ...
                      {!dynamicConnections && (
                        <div className="breakdown-note">Combined trainer + jockey rating</div>
                      )}
                    </div>
                  }
                />
                ...
                <CategoryCard
                  ...
                  details={
                    <div className="breakdown-details">
                      ...
                      <div className="breakdown-note">{score.breakdown.postPosition.reasoning}</div>
                    </div>
                  }
                />
                ...
                <CategoryCard
                  ...
                  details={
                    <div className="breakdown-details">
                      ...
                      <div className="breakdown-note">{score.breakdown.speedClass.reasoning}</div>
                      <div className="breakdown-hint">Based on current odds as class indicator</div>
                    </div>
                  }
                />
                  ...
                  details={
                    <div className="breakdown-details">
                      <div className="breakdown-row">
                        ...
                        <span className="breakdown-value">
                          {score.breakdown.form.recentFormScore}/15
                        </span>
                      </div>
                      <div className="breakdown-row">
                        <span className="breakdown-label">Layoff</span>
                        <span className="breakdown-value">
                          {score.breakdown.form.layoffScore}/10
                        </span>
                      </div>
                      ...
                      <div className="breakdown-note">{score.breakdown.form.reasoning}</div>
                    </div>
                  }
                />
                            ...
                            return (
                              ...
                              >
                                ...
                                <span
                                  ...
                                  style={{ color: formatted.color, fontWeight: 600 }}
                                >
                  ...
                  details={
                    <div className="breakdown-details">
                      ...
                      <div className="breakdown-row">
                        ...
                        <span className="breakdown-value">
                          {paceAnalysis.profile.stats.timesOnLead}/
                          {paceAnalysis.profile.stats.totalRaces} led early
                        </span>
                      </div>
                      ...
                      <div className="breakdown-row">
                        ...
                        >
                          {score.breakdown.pace.paceFit.charAt(0).toUpperCase() +
                            score.breakdown.pace.paceFit.slice(1)}
                        </span>
                      </div>

                      <div className="breakdown-note">{paceAnalysis.tactical.reasoning}</div>
                    </div>
                  }
                />
              </div>
                  ...
                  >
                    ...
                    >
                      <span
                        style={{
                          fontSize: '1.5rem',
                          color: getClassMovementColor(
                            score.classScore.analysis.movement.direction
                          ),
                        }}
                      >
                      ...
                      <div>
                        ...
                        >
                          {score.classScore.analysis.movement.direction === 'drop'
                            ? 'Class Drop'
                            : score.classScore.analysis.movement.direction === 'rise'
                              ? 'Class Rise'
                              : score.classScore.analysis.movement.direction === 'lateral'
                                ? 'Same Class'
                                : 'First Start'}
                        </div>
                      ...
                      >
                        <span
                          style={{
                            ...
                            color: getTierColor(
                              score.classScore.analysis.trackTierMovement.fromTier
                            ),
                            padding: '4px 8px',
                            borderRadius: '4px',
                            fontWeight: 600,
                        ...
                        >
                          {score.classScore.analysis.trackTierMovement.fromTrack} (
                        ...
                        >
                          {score.classScore.analysis.trackTierMovement.toTrack} (
                          {getTierDisplayName(score.classScore.analysis.trackTierMovement.toTier)})
                        </span>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {score.classScore.hiddenDropsScore}
                      </span>
                    </div>
                    <div
                      style={{
              ...
              <div className="breeding-info-box">
                ...
                <div className="breeding-experience-row">
                  ...
                  >
                    <Icon
                      name={
                        breedingInfo.experienceLevel === 'debut'
                          ? 'star'
                          : breedingInfo.experienceLevel === 'lightly_raced'
                            ? 'trending_up'
                            : 'verified'
                      }
                      className="text-sm"
                ...
                {breedingInfo.showBreedingScore && score.breedingScore?.wasApplied && (
                  <div
                    className="breeding-score-breakdown"
                    style={{
                      marginTop: '12px',
                      padding: '12px',
                      backgroundColor: '#1a1a1a',
              ...
              <div className="overlay-analysis-box">
                ...
                >
                  <div className="overlay-main-header">
                    ...
                    <span className="overlay-main-label">{VALUE_LABELS[overlay.valueClass]}</span>
                  </div>
                ...
                >
                    ...
                    <Icon
                      name={
                        overlay.recommendation.action === 'bet_heavily'
                          ...
                          : overlay.recommendation.action === 'bet_standard'
                            ? 'check_circle'
                            : overlay.recommendation.action === 'bet_small'
                              ? 'thumb_up'
                              : overlay.recommendation.action === 'avoid'
                                ? 'cancel'
                                : 'remove_circle'
                  ...
                  {overlay.recommendation.suggestedMultiplier > 0 &&
                    overlay.recommendation.action !== 'avoid' && (
                ...
                {valueAnalysis && (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {valueAnalysis.evPercent > 0 ? '+' : ''}
                        {valueAnalysis.evPercent.toFixed(0)}% EV
                      </div>
                    </div>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          {valueAnalysis.evPerDollar.toFixed(2)}
                        </span>
                      </div>
                    </div>
                ...
                {inefficiencyAnalysis &&
                  inefficiencyAnalysis.hasExploitableInefficiency &&
                  inefficiencyAnalysis.primaryInefficiency && (
                    <div
                      style={{
                        marginTop: '16px',
                    ...
                    >
                      ...
                      >
                        <Icon
                          name={
                            INEFFICIENCY_META[inefficiencyAnalysis.primaryInefficiency.type].icon
                          }
                          className="text-xl"
                        />
                        <div>
                ...
                >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      <span
                        style={{
                          fontSize: '1.5rem',
                          color:
                            LONGSHOT_CLASSIFICATION_META[longshotAnalysis.classification].color,
                        }}
                      >
                        <Icon
                          name={LONGSHOT_CLASSIFICATION_META[longshotAnalysis.classification].icon}
                        />
                      </span>
                      <div>
                        <div
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {longshotAnalysis.expectedValue.toFixed(2)}x
                      </div>
                    </div>
                    <div
                      style={{
                  ...
                  {longshotAnalysis.betRecommendation && (
                    <div
                      style={{
                        backgroundColor:
                          longshotAnalysis.classification === 'nuclear' ? '#22c55e15' : '#f59e0b15',
            ...
            <section className="modal-section">
              ...
              <div className="key-factors-list">
                {keyFactors.length > 0 ? (
                  ...
                  <KeyFactor
                    icon="info"
                    text="Average profile - no standout factors"
                    type="neutral"
                  />
                )}
              </div>
              ...
              <div className="pace-scenario-box">
                ...
                <div className="pace-scenario-content">
                  ...
                  <p className="pace-scenario-desc">{paceAnalysis.profile.description}</p>
                </div>
                ...
                <div className="pace-fit-section">
                  <div className="pace-fit-header">
                    <span
                      ...
                      style={{ color: PACE_SCENARIO_COLORS[paceAnalysis.scenario.scenario] }}
                    >
                      {paceAnalysis.scenario.scenario === 'soft'
                        ? 'trending_flat'
                        : paceAnalysis.scenario.scenario === 'moderate'
                          ? 'trending_up'
                          : paceAnalysis.scenario.scenario === 'contested'
                            ? 'local_fire_department'
                            : paceAnalysis.scenario.scenario === 'speed_duel'
                              ? 'whatshot'
                              : 'help_outline'}
                    </span>
            ...
            <section className="modal-section">
              ...
              <div className="drf-race-context">
                ...
                <span>
                  {raceHeader.trackCode} - Race {raceHeader.raceNumber}
                </span>
