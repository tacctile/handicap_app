...
describe('calculateKelly', () => {
  describe('basic Kelly formula', () => {
    it('calculates correct Kelly fraction for positive edge', () => {
      ...
      expect(result.fullKellyFraction).toBeCloseTo(0.10, 2)
    ...
    it('returns zero when edge is below minimum threshold', () => {
      ...
      const result = calculateKelly({
        ...
        bankroll: 1000,
        kellyFraction: 'full',
        minEdgeRequired: 0.10, // 10% minimum
      })
  ...
  describe('warnings', () => {
    it('warns when Kelly is too aggressive', () => {
      const result = calculateKelly({
        ...
        bankroll: 1000,
        kellyFraction: 'full',
        maxBetPercent: 0.50, // High cap to allow warning
      })
...
describe('confidenceToWinProbability', () => {
  ...
  it('clamps probability to valid range', () => {
    ...
    expect(highProb).toBeLessThanOrEqual(0.50)
  })
})
...
describe('calculateBatchKelly', () => {
  it('processes multiple bets correctly', () => {
    const bets = [
      ...
      { id: 'bet2', winProbability: 0.10, decimalOdds: 6.0 }, // Underlay
...
describe('edge cases', () => {
  ...
  it('handles very short odds', () => {
    ...
    expect(result.impliedProbability).toBeCloseTo(0.80, 2)
...
describe('constants', () => {
  it('has correct Kelly fraction values', () => {
    ...
    expect(KELLY_FRACTION_VALUES.half).toBe(0.50)
    expect(KELLY_FRACTION_VALUES.full).toBe(1.00)
  })
  ...
  it('has reasonable defaults', () => {
    ...
    expect(DEFAULT_MAX_BET_PERCENT).toBe(0.10)
  })
})
