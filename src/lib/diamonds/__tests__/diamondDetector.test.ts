...
import { analyzeDiamondCandidate, analyzeRaceDiamonds, mightBeDiamond } from '../diamondDetector';
import {
  validateDiamond,
  validateDiamonds,
...
vi.mock('../../equipment/trainerPatterns', () => ({
  getTrainerProfile: () => ({
    overallWinRate: 22,
    patterns: [{ type: 'lasix_first', winRate: 25, sampleSize: 20 }],
  }),
  getTrainerPattern: () => ({
    winRate: 25,
    sampleSize: 20,
