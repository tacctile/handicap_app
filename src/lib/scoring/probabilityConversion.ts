 ...
 * - scoreScale: Divisor to normalize racing scores (0-319) to softmax-friendly range
 */
export const SOFTMAX_CONFIG = {
  ...
  maxProbability: 0.95,
  /** Score scaling factor - divides scores to normalize for softmax (100 works well for 0-319 range) */
  scoreScale: 100,
} as const;
 ...
 *
 * @param scores - Array of raw scores (0-319 typical range)
...
export function softmaxProbabilities(
  ...
  // Scale scores to softmax-friendly range (racing scores 0-319 → ~0-3.19)
