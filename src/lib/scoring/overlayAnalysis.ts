...
export function generateOverlayDescription(
  ...
  const intensity = valueClass === 'massive_overlay' ? 'exceptional' :
                    valueClass === 'strong_overlay' ? 'excellent' :
                    valueClass === 'moderate_overlay' ? 'good' : 'slight'
 ...
 */
export function calculateTierAdjustment(score: number, overlayPercent: number): {
