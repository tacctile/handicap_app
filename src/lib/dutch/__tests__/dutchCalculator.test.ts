...
const createCandidateHorses = (): DutchCandidateHorse[] => [
  {
    programNumber: 1, horseName: 'Horse A', decimalOdds: 3.0, oddsDisplay: '2-1',
    tier: 1, confidence: 80, score: 190, estimatedWinProb: 0.35, hasOverlay: true,
  },
  {
    programNumber: 2, horseName: 'Horse B', decimalOdds: 6.0, oddsDisplay: '5-1',
    tier: 2, confidence: 65, score: 170, estimatedWinProb: 0.20, hasOverlay: true,
  },
  {
    programNumber: 3, horseName: 'Horse C', decimalOdds: 9.0, oddsDisplay: '8-1',
    tier: 2, confidence: 55, score: 160, estimatedWinProb: 0.12, hasOverlay: false,
  },
  {
    programNumber: 4, horseName: 'Horse D', decimalOdds: 15.0, oddsDisplay: '14-1',
    tier: 3, confidence: 40, score: 140, estimatedWinProb: 0.07, hasOverlay: true,
  },
]
...
describe('Dutch Book Optimizer', () => {
  ...
  describe('getTopDutchOpportunities', () => {
    ...
    it('ranks by recommendation strength', () => {
      ...
      for (let i = 1; i < opportunities.length; i++) {
        expect(opportunities[i - 1].recommendationStrength)
          .toBeGreaterThanOrEqual(opportunities[i].recommendationStrength)
      }
    })
  })
  ...
  describe('convertToDutchCandidates', () => {
    it('converts horse data to candidates', () => {
      const input = [
        { programNumber: 1, horseName: 'A', morningLineOdds: '2-1', score: 190, confidence: 80, tier: 1 as const },
        { programNumber: 2, horseName: 'B', morningLineOdds: '5-1', score: 170, confidence: 65, tier: 2 as const },
      ]
