...
import { generateComparisonTable, compareStructuresForType } from '../exoticComparison';
...
describe('Superfecta Cost Calculations', () => {
  ...
  describe('calculateSuperfectaKeyCost', () => {
    it('should calculate key superfecta correctly', () => {
      const result = calculateSuperfectaKeyCost([1], [2, 3, 4], [2, 3, 4], [2, 3, 4], 0.1);
      expect(result.isValid).toBe(true);
  ...
  describe('calculateSuperfectaPartWheelCost', () => {
    it('should calculate part wheel correctly', () => {
      const result = calculateSuperfectaPartWheelCost([1, 2], [3, 4], [5, 6], [7, 8], 0.1);
      expect(result.isValid).toBe(true);
