...
describe('analyzeValue', () => {
  ...
  it('should calculate edge correctly', () => {
    ...
    expect(analysis.edge).toBeCloseTo(
      analysis.ourProbability - analysis.marketProbability,
      1
    )
  })
...
describe('VALUE_CLASSIFICATION_META', () => {
  it('should have metadata for all classifications', () => {
    ...
    for (const classification of classifications) {
      const meta = VALUE_CLASSIFICATION_META[classification as keyof typeof VALUE_CLASSIFICATION_META]
