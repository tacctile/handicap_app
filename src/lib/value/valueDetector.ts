...
export const VALUE_CLASSIFICATION_META: Record<ValueClassification, {
  name: string
  shortName: string
  color: string
  bgColor: string
...
export function formatOddsDisplay(decimalOdds: number): string {
  ...
  const patterns: [number, string][] = [
    [0.2, '1-5'], [0.25, '1-4'], [0.33, '1-3'], [0.5, '1-2'],
    [0.6, '3-5'], [0.67, '2-3'], [0.75, '3-4'], [0.8, '4-5'],
    [1.0, 'EVEN'], [1.2, '6-5'], [1.5, '3-2'], [2.0, '2-1'],
    [2.5, '5-2'], [3.0, '3-1'], [3.5, '7-2'], [4.0, '4-1'],
    [5.0, '5-1'], [6.0, '6-1'], [7.0, '7-1'], [8.0, '8-1'],
    [9.0, '9-1'], [10.0, '10-1'], [12.0, '12-1'], [15.0, '15-1'],
    [20.0, '20-1'], [30.0, '30-1'], [50.0, '50-1'], [100.0, '100-1'],
  ]
...
export function analyzeRaceValue(
  ...
  const stats = {
    averageEV: evValues.length > 0
      ? evValues.reduce((sum, ev) => sum + ev, 0) / evValues.length
      : 0,
