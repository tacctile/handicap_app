...
function createHorseWithClassData(classData: Record<string, unknown>, horseOverrides = {}) {
  ...
  describe('Hidden Class Drops', () => {
    it('detects track tier drop (A→C = +8 pts)', () => {
      const horse = createHorseWithClassData(
        ...
        {
          pastPerformances: [createPastPerformance({ track: 'SAR' })],
        }
      );
    ...
    it('detects purse drop as hidden value', () => {
      const horse = createHorseWithClassData(
        ...
        {
          pastPerformances: [createPastPerformance({ purse: 100000 })],
        }
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('handles missing purse data gracefully', () => {
      const horse = createHorseWithClassData(
        ...
        {
          pastPerformances: [createPastPerformance({ purse: undefined as unknown as number })],
        }
      );
